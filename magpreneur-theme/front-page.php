<?php get_header();?>
  ...
  $featured_posts_featured_pic_id = get_post_thumbnail_id(get_the_ID());
  ?>
  <section class="py-5">
        ...
        <div id="editor-choice" class="col-lg-8">
          ...
          <div class="row row-cols-1 row-cols-sm-2 gy-4 pt-3 gx-sm-5">
            ...
            while ($featuredPosts->have_posts()){
              ...
              $featured_post_cat = get_the_category();
              ?>
              <div class="col">
              <div class="card mob-card-view card-max-width">
                <div class="col-4 col-sm-12 py-0 card-img-box">
                <?php 
            if($featured_posts_featured_pic_id){
            echo wp_get_attachment_image($featured_posts_featured_pic_id, 'largeCard', false, [
            ...
            ?>
                ...
                <div class="col-8 col-sm-12">
                  <div class="card-body">
                  <?php
                  if (!empty($featured_post_cat)) { ?>
                    <!-- // Find the first subcategory (parent != 0) -->
                    <small class="card-category">
                    <a href="<?php echo esc_url(get_category_link($featured_post_cat[0]->term_id)); ?>">
                        <?php echo esc_html($featured_post_cat[0]->name); ?>
                    </a>
                    </small>
                  <?php }
                  ?>
